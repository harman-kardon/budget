...
var budgetController = (function() {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            // create an array with all the ids and their index
        ...
        calculateBudget: function() {
            ...
            // calculcate sum of all incomes and all expenses
            calculateTotal('exp');
            calculateTotal('inc');
        ...
        calculatePercentage: function() {
            ...
            // loop over each item in expenses and call the calcPercentage prototype method
...
var UIController = (function(){
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        num = Math.abs(num);
        num = num.toFixed(2); // method that put 2 decimal numbers
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            // replace the placeholder with text from actual data
        ...
        clearFields: function() {
            ...
            // converting a list (fields) to an array with slice prototype and call.
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            // inc-1 - using split methode to split string class of div
